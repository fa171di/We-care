                    ...
                    <div class="d-flex">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-style2">
                                ...
                                <li class="breadcrumb-item active">اضافة سؤال</li>
                            </ol></nav>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body">
            <form action="{{ route('questions.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mg-b-20">
                    ...
                    <div class="parsley-input col-md-10 mg-t-20 mg-md-t-0" id="lnWrapper">
                        <x-forms.label id=""><span class="">السؤال : </span></x-forms.label>

                        <textarea class="form-control" name="Question" style="height: 215px;" placeholder="Textarea" rows="3"></textarea>
