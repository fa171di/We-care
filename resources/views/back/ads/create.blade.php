...
@section('content')
    ...
    border-radius: 33px;
    margin-bottom: 16px;">
                            <input type="radio" required value="1" style="margin-left: 5px;width: 15px;height: 15px;" name="statue">
                            <label for="outline" style="margin-left: 11px;color: #069f06;font-size: 18px;">معروض</label>
                            <input type="radio" required value="0" checked style="margin-left: 5px;width: 15px;height: 15px;" name="statue">
                    ...
                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                        ...
                        <textarea class="form-control" name="text" style="height: 215px;" placeholder="Textarea" rows="3"></textarea>
