                ...
                <div class="card-body">
                    <div class="main-content-label mg-b-5">
                        <div class="form-group">
                            <p>اسم الصلاحية :</p>
                            <x-forms.input label="اسم الصلاحية :"  requiredInput="*" placeholder="Name" :value="$role->name" name="name" />
                        </div>
                    </div>
                    <div class="row">
                        <!-- col -->
                                    ...
                                    <ul>
                                        <li>
                                            @foreach($permission as $value)
                                                <label style="font-size: 16px;" class="ckbox">
                                                    <input name="permission[]"
                                                           value="{{$value->id}}"
                                                           type="checkbox"
                                                           @isset($rolePermissions[$value->id])
                                                           checked
                                                           @endisset ><span> {{ $value->name }}</span>
                                                </label>
                                            @endforeach
                                        </li>
