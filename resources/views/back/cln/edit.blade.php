            ...
            <div class="d-flex">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style2">
                        ...
                        <li class="breadcrumb-item active">تعديل الفحص السريري</li>
                    </ol>
                </nav>
            </div>
        </div>
...
@section('content')
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">الفحص السريري</div>
                        </div>
                    </div>
                </div>
            </div><br>

            <form id="" action="{{route('cln.update','cln')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
...
<script>
    ...
    $(".menuicon").click(function() {
        ...
        added_row = '<div style="position: relative"><textarea class="form-control" name="cln[]" style="height: 41px;"placeholder="Textarea" rows="3"></textarea> <i style="color: red;position: absolute;left: 10px;font-size: 30px;bottom: 5px;"class="las la-minus"></i></div>';
