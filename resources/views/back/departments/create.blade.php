                    ...
                    <div class="main-content-label mg-b-5">
                        <div class="col-xs-7 col-sm-7 col-md-7">
                            <div class="form-group">
                                <x-forms.input label="اسم الصلاحية :"  requiredInput="*"  name="name" />
                                ...
                                <li><a href="#">الصلاحيات</a>
                                    <ul>
                                        ...
                                        @foreach($permission as $value)
                                            <label style="font-size: 16px;" class="ckbox"><input name="permission[]"
                                                                                                 value="{{$value->id}}"
                                                                                                 type="checkbox"><span> {{ $value->name }}</span>
                                            </label>
