...
@section('content')
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">اضافة معلومات للسوابق المرضية</div>
                        ...
                        <form id="medicalForm" action="{{route('medical.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            ...
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <textarea class="form-control" name="note1" style="height: 41px;" placeholder="Textarea" rows="3">Textarea</textarea>
                                </div>
                            ...
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <textarea class="form-control" name="note2" style="height: 41px;" placeholder="Textarea" rows="3">Textarea</textarea>
                                </div>
                            </div>
                            <div class="row mg-b-20">
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <textarea class="form-control" name="note3" style="height: 41px;" placeholder="Textarea" rows="3">Textarea</textarea>
                                </div>
                            ...
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <textarea class="form-control" name="note4" style="height: 41px;" placeholder="Textarea" rows="3">Textarea</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <textarea class="form-control" name="note5" style="height: 41px;" placeholder="Textarea" rows="3">Textarea</textarea>
                                </div>
                            </div>
                            <div class="mg-t-30">
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">الشكاية الرئيسية</div>
            ...
            <form id="" action="{{route('com.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <x-forms.input id="" hidden="" name="visit" :value="$visit" />
                <x-forms.input id="" hidden="" name="patient" :value="$patient" />
                <div class="row mg-b-20">
                    <div class="parsley-input col-md-9" id="fnWrapper">
                        <x-forms.label id=""><span class="">الشكاية :  </span></x-forms.label>
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-1" id="fnWrapper">
                                <a class="menuicon"><i style="color: blue;font-size: 28px;" class="las la-plus"></i></a>
                            </div>
                            <div class="parsley-input col-md-8" id="textareaNew">
                                <div class="parent" style="position: relative;">
                                    <textarea class="form-control" name="com[]" style="height: 41px;" placeholder="Textarea" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">القصة المرضية</div>
            ...
            <form id="" action="{{route('str.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <x-forms.input id="" hidden="" name="visit" :value="$visit" />
                <x-forms.input id="" hidden="" name="patient" :value="$patient" />
                <div class="row mg-b-20">
                    <div class="parsley-input col-md-9" id="fnWrapper">
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-1" id="fnWrapper">
                                <a class="strIcon"><i style="color: blue;font-size: 28px;" class="las la-plus"></i></a>
                            </div>
                            <div class="parsley-input col-md-8" id="strNew">
                                <div class="parent" style="position: relative;">
                                    <x-forms.label id=""><span class="">القصة :  </span></x-forms.label>
                                    <textarea class="form-control" name="str[]" style="height: 41px;" placeholder="Textarea" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">فحص سريري</div>
            ...
            <form id="" action="{{route('cln.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <x-forms.input id="" hidden="" name="visit" :value="$visit" />
                <x-forms.input id="" hidden="" name="patient" :value="$patient" />
                <div class="row mg-b-20">
                    <div class="parsley-input col-md-9" id="fnWrapper">
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-1" id="fnWrapper">
                                <a class="clnIcon"><i style="color: blue;font-size: 28px;" class="las la-plus"></i></a>
                            </div>
                            <div class="parsley-input col-md-8" id="clnNew">
                                <div class="parent" style="position: relative;">
                                    <x-forms.label id=""><span class="">الفحص :  </span></x-forms.label>
                                    <textarea class="form-control" name="cln[]" style="height: 41px;" placeholder="Textarea" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">التشخيص</div>
            ...
            <form id="Form" action="{{route('dia.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <x-forms.input id="" hidden="" name="visit" :value="$visit" />
                <x-forms.input id="" hidden="" name="patient" :value="$patient" />
                ...
                <div class="row mg-b-20">
                    <div class="parsley-input col-md-3" id="fnWrapper">
                        <x-forms.label id=""><span class="">اضغط لعرض التشخيصات الخاصة به:</span></x-forms.label>
                        <ul id="icd10display">
                            <th><a href="#" id="1" class="btn btn-sm btn-outline-secondary">أمراض انتانية وطفيلية محددة</a></th>
                            <th><a href="#" id="2" class="btn btn-sm btn-outline-secondary">أمراض تنشؤية</a></th>
                            <th><a href="#" id="3" class="btn btn-sm btn-outline-secondary">أمراض الدم والأعضاء المنتجة للدم واضطرابات محددة تصيب الآلية المناعية</a></th>
                            <th><a href="#" id="4" class="btn btn-sm btn-outline-secondary">الأمراض الغدية الصماوية,التغذوية , والاستقلابية</a></th>
                            <th><a href="#" id="5" class="btn btn-sm btn-outline-secondary">الاضطرابات العقلية والسلوكية</a></th>
                            <th><a href="#" id="6" class="btn btn-sm btn-outline-secondary">أمراض الجهاز العصبي</a></th>
                            <th><a href="#" id="7" class="btn btn-sm btn-outline-secondary">أمراض العين وملحقاتها</a></th>
                            <th><a href="#" id="8" class="btn btn-sm btn-outline-secondary">أمراض الأذن والناتئ الخشائي</a></th>
                            <th><a href="#" id="9" class="btn btn-sm btn-outline-secondary">أمراض الجهاز الدوراني</a></th>
                            <th><a href="#" id="10" class="btn btn-sm btn-outline-secondary">أمراض الجهاز التنفسي</a></th>
                            <th><a href="#" id="11" class="btn btn-sm btn-outline-secondary">أمراض الجهاز الهضمي</a></th>
                            <th><a href="#" id="12" class="btn btn-sm btn-outline-secondary">أمراض الجلد والنسيج تحت الجلد</a></th>

                            <th><a href="#" id="13" class="btn btn-sm btn-outline-secondary">أمراض الجهاز العضلي الهيكلي والنسيج الضام</a></th>
                            <th><a href="#" id="14" class="btn btn-sm btn-outline-secondary">أمراض الجهاز البولي التناسلي</a></th>
                            <th><a href="#" id="15" class="btn btn-sm btn-outline-secondary">الحمل,الولادة والنفاس</a></th>
                            <th><a href="#" id="16" class="btn btn-sm btn-outline-secondary">حالات نوعية تحصل في الفترة حول الولادة</a></th>
                            <th><a href="#" id="17" class="btn btn-sm btn-outline-secondary">تشوهات خلقية, أسواء تشكل وشذوذات صبغية</a></th>
                            <th><a href="#" id="18" class="btn btn-sm btn-outline-secondary">أعراض ,علامات وموجودات سريرية ومخبرية غير طبيعية ,غير مصنفة في مكان آخر</a></th>
                            <th><a href="#" id="19" class="btn btn-sm btn-outline-secondary">أذية,تسمم وعقابيل أخرى محددة من أسباب خارجية</a></th>
                            <th><a href="#" id="20" class="btn btn-sm btn-outline-secondary">رموز لأغراض خاصة</a></th>
                            <th><a href="#" id="21" class="btn btn-sm btn-outline-secondary">أسباب خارجية للمراضة والوفاة</a></th>
                            <th><a href="#" id="22" class="btn btn-sm btn-outline-secondary">عوامل مؤثرة في الوضع الصحي والاتصال بالخدمات الصحية</a></th>
                        </ul>
                    </div>
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">الملاحظات</div>
            ...
            <form id="" action="{{route('note.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <x-forms.input id="" hidden="" name="visit" :value="$visit" />
                <x-forms.input id="" hidden="" name="patient" :value="$patient" />
                <div class="row mg-b-20">
                    <div class="parsley-input col-md-9" id="fnWrapper">
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-1" id="fnWrapper">
                                <a class="noteIcon"><i style="color: blue;font-size: 28px;" class="las la-plus"></i></a>
                            </div>
                            <div class="parsley-input col-md-8" id="noteNew">
                                <div class="parent" style="position: relative;">
                                    <x-forms.label id=""><span class="">الملاحظة :  </span></x-forms.label>
                                    <textarea class="form-control" name="note[]" style="height: 41px;" placeholder="Textarea" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    padding-bottom: 10px;" class="content-title mb-0 my-auto">مؤشرات النمو</div>
            ...
            <form id="" action="{{route('MedicalFile.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                @if(empty($patientInfoExiste))
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-4" id="fnWrapper">
                            <x-forms.input label="الطول: " oninvalid="this.setCustomValidity('يجب ان تدخل رقم')" onchange="this.setCustomValidity('')" inputmode="numeric" pattern="[0-9]*" requiredInput="*" class="required" name="height"  />
                        </div>
                        <div class="parsley-input col-md-4" id="fnWrapper">
                            <x-forms.input label="طول الاب: " oninvalid="this.setCustomValidity('يجب ان تدخل رقم')" onchange="this.setCustomValidity('')" inputmode="numeric" pattern="[0-9]*" requiredInput="*" class="required" name="father_height"  />
                        </div>
                        <div class="parsley-input col-md-4" id="fnWrapper">
                            <x-forms.input label="طول الام: " oninvalid="this.setCustomValidity('يجب ان تدخل رقم')" onchange="this.setCustomValidity('')" inputmode="numeric" pattern="[0-9]*" requiredInput="*" class="required" name="mother_height"  />
                        </div>
                    </div>
                @else
                    <div class="table-responsive hoverable-table">
                        <ul class="list-group list-group-horizontal-lg">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @if($patientInfoExiste->sex == 1)
                                    <svg xmlns="http://www.w3.org/2000/svg" style="color: dodgerblue" width="30" height="30" fill="currentColor" class="bi bi-gender-male" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M8 1a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM3 5a5 5 0 1 1 5.5 4.975V12h2a.5.5 0 0 1 0 1h-2v2.5a.5.5 0 0 1-1 0V13h-2a.5.5 0 0 1 0-1h2V9.975A5 5 0 0 1 3 5z"/>
                                    </svg>
                                @else
                                    <svg xmlns="http://www.w3.org/2000/svg" style="color: hotpink" width="30" height="30" fill="currentColor" class="bi bi-gender-female" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M8 1a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM3 5a5 5 0 1 1 5.5 4.975V12h2a.5.5 0 0 1 0 1h-2v2.5a.5.5 0 0 1-1 0V13h-2a.5.5 0 0 1 0-1h2V9.975A5 5 0 0 1 3 5z"/>
                                    </svg>
                                @endif
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" style="color: grey" width="30" height="30" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
